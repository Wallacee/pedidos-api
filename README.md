...
| DataCriacao | DateTime | Data e hora de criação do pedido             |
| Status      | enum     | Status do pedido (Novo, Pago, Cancelado)    |
| ValorTotal  | decimal  | Valor total calculado a partir dos itens     |
...
| Quantidade   | int      | Quantidade do item (maior que zero)          |
| PrecoUnitario| decimal  | Preço unitário do produto (maior que zero)  |
...
Em cenários de time, a estratégia usual incluiria a dev, feature branches e etc.
